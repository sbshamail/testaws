...
function AuthenticomPointsUnassignedName({
  loading,
  responseState,
  formdataObject,
}) {
                    ...
                    <tbody>
                      {responseState?.CustomerSummay?.map((dealer, index) => (
                        <tr key={dealer?.DealerID}>
                          ...
                          <td className="border border-card-foreground/10 px-4 py-2 text-right   ">
                            <div className="bg-green-500 py-1 px-4 text-white tracking-wider rounded-xl">
                              Assign
                            </div>
                          </td>
                        </tr>
...
export default AuthenticomPointsUnassignedName;
